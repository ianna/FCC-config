...
import math
innerVertexResolution_x = 0.003 # [mm], assume 3 <C2><B5>m resolution for ARCADIA sensor
innerVertexResolution_y = 0.003 # [mm], assume 3 <C2><B5>m resolution for ARCADIA sensor
innerVertexResolution_t = 1000 # [ns]
outerVertexResolution_x = 0.050/math.sqrt(12) # [mm], assume ATLASPix3 sensor with 50 <C2><B5>m pitch
outerVertexResolution_y = 0.150/math.sqrt(12) # [mm], assume ATLASPix3 sensor with 150 <C2><B5>m pitch
